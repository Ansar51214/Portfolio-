...
import abuBakarPortfolio from "@/assets/abu-bakar-portfolio.png";
import drAsifWebsite from "@/assets/dr-asif.png";
...
const caseStudyFeatures = [
  ...
  "Mobile-ready client experience",
];
  ...
  return (
    <div className="portfolio">
      ...
      <section id="projects" className="reveal">
        ...
        <div className="case-study-hook">
          <div>
            <span>Built to win clients</span>
            <h3>Every project is presented with the business goal, conversion flow, and client value.</h3>
          </div>
        ...
        <div className="projects-grid">
          <div className="project-card featured has-preview">
            ...
            <ul className="project-highlights" aria-label="Project highlights">
              <li>Multi-page institutional presence</li>
              <li>Admin, student, and teacher portal screens</li>
              <li>Admissions and department structure</li>
            </ul>
          ...
          <div className="project-card">
            ...
            <ul className="project-highlights" aria-label="Project highlights">
              <li>Clear services and expertise positioning</li>
              <li>Direct email and WhatsApp contact paths</li>
              <li>Responsive design for mobile visitors</li>
            </ul>
            <div className="project-footer">
          ...
          <div className="project-card">
            ...
            <div className="project-mockup" aria-label="Muhammad Abu Bakar Siddique Shah portfolio preview">
              <div className="mockup-bar">
                <span className="mockup-dot red" />
                <span className="mockup-dot yellow" />
                <span className="mockup-dot green" />
              </div>
              <div className="mockup-thumb tall-preview">
                <img
                  src={abuBakarPortfolio}
                  alt="Muhammad Abu Bakar Siddique Shah portfolio website"
                  loading="lazy"
                />
              </div>
            </div>
            ...
            <ul className="project-highlights" aria-label="Project highlights">
              <li>Leadership profile and credibility sections</li>
              <li>Achievements, initiatives, and media showcase</li>
              <li>Official contact information for visitors</li>
            </ul>
            <div className="project-footer">
          ...
          <div className="project-card has-preview">
            <div className="status-badge live">Website</div>
            <div className="project-num">04</div>
            <div className="project-mockup" aria-label="Al-Falah Artificial Limbs Center website preview">
              <div className="mockup-bar">
                <span className="mockup-dot red" />
                <span className="mockup-dot yellow" />
                <span className="mockup-dot green" />
              ...
              <div className="mockup-thumb tall-preview">
                <img
                  src={drAsifWebsite}
                  alt="Al-Falah Artificial Limbs Center website for Dr. Asif"
                  loading="lazy"
                />
              </div>
            </div>
            <h3>Dr. Asif Medical Website</h3>
            <p>
              Designed a professional prosthetics and orthotics website for Al-Falah Artificial
              Limbs Center, featuring services, technology highlights, patient stories, FAQs,
              consultation booking, and contact sections.
            </p>
            <ul className="project-highlights" aria-label="Project highlights">
              <li>Appointment booking and WhatsApp lead capture</li>
              <li>Patient success stories for stronger trust</li>
              <li>FAQs and services built for quick decisions</li>
            </ul>
            <div className="project-footer">
              <span className="tech-stack">Healthcare / Landing Page / WhatsApp Lead Flow</span>
              <div className="project-actions">
                <a href="#contact" className="project-btn">
                  Live Preview
                </a>
          ...
          <div className="project-card">
            ...
            <ul className="project-highlights" aria-label="Project highlights">
              <li>Automated lead capture and notifications</li>
              <li>Follow-up reminders for better response</li>
              <li>App-to-app workflow integration</li>
            </ul>
            <div className="project-footer">
